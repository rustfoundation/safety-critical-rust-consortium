...
If you want to add or update the list, please open an issue on the [safety-critical-rust-consortium](https://github.com/rustfoundation/safety-critical-rust-consortium) repository.
