...
| **1l** | Fault injection test | (Tools) **possible** to manually implement fault injections. Currently no tool support | 🟢 |
...
| **1b** | Branch coverage | **not available** yet | 🔴 |
...
| **1c** | Fault injection test | (Tools) **possible** to manually implement fault injections. Currently no tool support | 🟢 |
| **1d** | Resource usage evaluation | (Tools) **exist** e.g. Orbuculum or TRACE32 by Lauterbach | 🟡 |
| **1e** | Back-to-back comparison test | (Tools) **not available** requires model generators to support Rust and export test vectors | 🔴 |
...
| **1b** | Fault injection test | (Tools) **possible** to manually implement fault injections. Currently no tool support | 🟢 |
